...
gnomad <-
  read.delim(paste0(path, "/gnomAD_raw_data/five_chgenes_in_cosmicdata.vcf.gz"), 
             header = FALSE, 
...
In here, I show the distribution of all the variants in DNMT3A gene
...
gnomad_decoded4 <- gnomad_decoded4 %>% 
  mutate(gene = str_match(gnomad_decoded4$INFO, "(DNMT3A|TET2|TP53)(.*?)$")[,2])
```
